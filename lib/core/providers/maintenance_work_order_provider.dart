...
import 'package:shehabapp/core/services/maintenance_work_order_service.dart';

class MaintenanceWorkOrderProvider extends ChangeNotifier {
  final MaintenanceWorkOrderService _service = MaintenanceWorkOrderService();
