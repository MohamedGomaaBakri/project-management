...
class _WorkshopsScreenState extends State<WorkshopsScreen>
  ...
  Future<void> _fetchWorkOrders() async {
    const String apiUrl =
        "http://195.201.246.251:7013/TdpSelfServiceWebSrvc-RESTWebService-context-root/rest/V1/MneWorkOrdersMastVO1";
    try {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "${_workOrders.length} ${l10n.workOrders}",
                                  style: TextStyle(
                                    fontSize: 14,
  ...
  Widget _buildStatusChip(String status, bool isDelivered) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (isDelivered ? Colors.green : Colors.orange).withOpacity(
              0.2,
            ),
            blurRadius: 8,
