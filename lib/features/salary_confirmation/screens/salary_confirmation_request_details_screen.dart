...
class SalaryConfirmationRequestDetailsScreen extends StatefulWidget {
  ...
  @override
  State<SalaryConfirmationRequestDetailsScreen> createState() => _SalaryConfirmationRequestDetailsScreenState();
}

class _SalaryConfirmationRequestDetailsScreenState extends State<SalaryConfirmationRequestDetailsScreen> {
  ...
  void _showActionDialog(BuildContext context, SalaryConfirmationRequestItem request) {
  ...
  Future<void> _submitAction(int authFlag, BuildContext dialogContext, SalaryConfirmationRequestItem request) async {
    final hrProvider = Provider.of<HrProvider>(context, listen: false);
