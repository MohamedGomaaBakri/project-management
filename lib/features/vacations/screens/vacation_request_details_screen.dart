...
class _VacationRequestDetailsScreenState extends State<VacationRequestDetailsScreen> {
  ...
  Future<void> _submitAction(int authFlag, BuildContext dialogContext, VacationRequestItem request) async {
    final hrProvider = Provider.of<HrProvider>(context, listen: false);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(l10n.vacationTypeLabel, vacationType ?? l10n.notSpecified),
            _buildDetailRow(l10n.startDateLabel, _formatDate(request.startDt, "yyyy-MM-dd")),
            _buildDetailRow(l10n.endDateLabel, _formatDate(request.endDt, "yyyy-MM-dd")),
            _buildDetailRow(l10n.durationLabel, '${request.period ?? '0'} ${l10n.daysUnit}'),
