...
class CancelSalaryConfirmationRequestDetailsScreen extends StatefulWidget {
  ...
  @override
  State<CancelSalaryConfirmationRequestDetailsScreen> createState() => _CancelSalaryConfirmationRequestDetailsScreenState();
}

class _CancelSalaryConfirmationRequestDetailsScreenState extends State<CancelSalaryConfirmationRequestDetailsScreen> {
  ...
  void _showActionDialog(BuildContext context, CancelSalaryConfirmationRequestItem request) {
  ...
  Future<void> _submitAction(int authFlag, BuildContext dialogContext, CancelSalaryConfirmationRequestItem request) async {
    final hrProvider = Provider.of<HrProvider>(context, listen: false);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(l10n.requestDateLabel, _formatDate(request.trnsDate, "yyyy-MM-dd")),
  ...
  Widget _buildAuthDetailsTab(HrProvider provider) {
    final l10n = AppLocalizations.of(context)!;
    if (provider.isLoading && provider.cancelSalaryConfirmationAuthDetails == null) {
