...
class RequestMaterialAndApprovalSelectionView extends StatefulWidget {
  const RequestMaterialAndApprovalSelectionView({super.key});

  static const String routeName =
      'request_material_and_approval_selection_view';

  @override
  State<RequestMaterialAndApprovalSelectionView> createState() =>
      _RequestMaterialAndApprovalSelectionViewState();
}

class _RequestMaterialAndApprovalSelectionViewState
    extends State<RequestMaterialAndApprovalSelectionView>
        ...
        child: SafeArea(
          child: FadeTransition(
            ...
            child: SlideTransition(
              ...
              child: Column(
                children: [
                  _RequestMaterialAndApprovalHeader(l10n: l10n),
                  Expanded(
                    child: Container(
                      ...
                      child: _RequestMaterialAndApprovalBody(l10n: l10n),
                    ),
                  ),
                ],
              ),
...
class _RequestMaterialAndApprovalHeader extends StatelessWidget {
  final AppLocalizations l10n;

  const _RequestMaterialAndApprovalHeader({required this.l10n});
...
class _RequestMaterialAndApprovalBody extends StatelessWidget {
  final AppLocalizations l10n;

  const _RequestMaterialAndApprovalBody({required this.l10n});
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  // ── Disbursement Requests card (always visible) ──────────────────────────
                  _AnimatedSelectionCard(
                    delay: 100,
                    child: SelectionCardWidget(
                      title: l10n.disbursementRequestsSelection,
                      subtitle: l10n.disbursementRequestsSelectionDesc,
                      icon: Icons.assignment_turned_in_rounded,
                      gradient: const [Color(0xFF4F46E5), Color(0xFF6366F1)],
                      onTap: () {
                        Navigator.pushNamed(
                          context,
                          DisbursementRequests.routeName,
                        );
                      },
                    ),
                  ),
