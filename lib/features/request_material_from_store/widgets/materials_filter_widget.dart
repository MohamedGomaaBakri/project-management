...
/// Status filter options mapped to statusFlag values.
enum StatusFilterFlag {
  all,
  done, // statusFlag == 1
  notDone, // statusFlag == 0
}

/// Filter card: date picker field + approval radio buttons + status radio buttons + search/reset buttons.
class MaterialsFilterWidget extends StatelessWidget {
  final DateTime? selectedDate;
  final AuthFilterStatus selectedAuth;
  final StatusFilterFlag selectedStatus;
  final ValueChanged<DateTime?> onDateChanged;
  final ValueChanged<AuthFilterStatus> onAuthChanged;
  final ValueChanged<StatusFilterFlag> onStatusChanged;
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 4,
          children: [
            _AuthRadioChip<AuthFilterStatus>(
...
class _StatusRadioGroup extends StatelessWidget {
  final AppLocalizations l10n;
  final StatusFilterFlag selectedStatus;
  final ValueChanged<StatusFilterFlag> onChanged;
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              l10n.statusFilter, // Assuming statusFilter key exists, else fallback
              style: const TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: Color(0xFF374151),
        ...
        Wrap(
          ...
          runSpacing: 4,
          children: [
            _AuthRadioChip<StatusFilterFlag>(
              label: l10n.allStatus, // using existing key
              value: StatusFilterFlag.all,
              groupValue: selectedStatus,
              onChanged: onChanged,
            ),
            _AuthRadioChip<StatusFilterFlag>(
              label: l10n.doneOnly, // using existing key
              value: StatusFilterFlag.done,
              groupValue: selectedStatus,
              onChanged: onChanged,
              activeColor: Colors.green,
            ),
            _AuthRadioChip<StatusFilterFlag>(
              label: l10n.notDoneOnly, // using existing key
              value: StatusFilterFlag.notDone,
              groupValue: selectedStatus,
              onChanged: onChanged,
              activeColor: Colors.orange,
            ),
...
class _AuthRadioChip<T> extends StatelessWidget {
  final String label;
  final T value;
  final T groupValue;
