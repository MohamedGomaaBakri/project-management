...
class MaterialDetailSectionCard extends StatelessWidget {
  final String title;
  final IconData icon;
  final Color accentColor;
  final List<Widget> children;

  const MaterialDetailSectionCard({
    super.key,
    required this.title,
    required this.icon,
...
class MaterialDetailInfoRow extends StatelessWidget {
  final String label;
  final String value;
  final IconData? icon;
  final Color? valueColor;

  const MaterialDetailInfoRow({
    super.key,
    required this.label,
    required this.value,
    this.icon,
...
/// Editable quantity field used when authFlag allows editing.
class MaterialEditableFieldsWidget extends StatelessWidget {
  final TextEditingController quantityController;
  final bool isReadOnly;
  final AppLocalizations l10n;

  const MaterialEditableFieldsWidget({
    super.key,
...
class MaterialAuthStatusBadge extends StatelessWidget {
  final int? authFlag;
  final String statusText;

  const MaterialAuthStatusBadge({
    super.key,
